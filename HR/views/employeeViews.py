...
def addEmployee(request):
  ...
  if request.method == "POST":
    ...
    # print(first_name)
    employee_list = Employee.objects.create(first_name=request.POST["first_name"], last_name=last_name, start_date=start_date, is_supervisor=is_supervisor, department_id=department_id.id)
